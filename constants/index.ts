...
export const companies: CompanyOption[] = Object.entries(companyLogos).map(
  ([name, logo]) => ({ name, logo })
);
...
export const experienceLevels = ["Junior", "Mid-Level", "Senior", "Lead", "Principal"];

export const interviewTypes = ["Technical", "Behavioral", "Mixed", "System Design"];
